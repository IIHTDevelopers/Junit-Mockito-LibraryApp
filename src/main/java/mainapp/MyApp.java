...
import com.libraryapp.test.LibraryAppTest;

public class MyApp {

	public static void main(String[] args) throws IOException {

		String sourcePath = "src/main/java/com/libraryapp/test/LibraryAppTest.java";
		String destPath = "src/test/java/com/libraryapp/test/LibraryAppTest.java";
		copyFile(sourcePath, destPath);
		Result result = JUnitCore.runClasses(LibraryAppTest.class);
		...
		try{
			...
			try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
				...
				while ((linen = br.readLine()) != null) {
					...
					if (columns.length > 2 && columns[2].contains("LibraryManager")) {
